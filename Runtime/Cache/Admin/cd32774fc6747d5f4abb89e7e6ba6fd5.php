...
<div id="main-content">
    ...
    <link type="text/css" rel="stylesheet" href="/thinkox4/Public/Core/js/ext/magnific/magnific-popup.css"/>
    <!-- 标题 -->
...
<?php if(count($searches) > 0): ?><button class="btn submit-btn" url="?status=-1" target-form="ids" style="padding: 6px 16px;" onclick="toggle_search()">搜索</button><?php endif; ?>
    ...
    <script type="text/javascript" src="/thinkox4/Public/static/thinkbox/jquery.thinkbox.js"></script>
...
//        });
    ...
    <script type="text/javascript" src="/thinkox4/Public/Core/js/ext/magnific/jquery.magnific-popup.min.js"></script>
