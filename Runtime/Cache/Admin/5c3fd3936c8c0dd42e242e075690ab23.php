...
<head>
    ...
    <link href="/thinkox4/Public/favicon.ico" type="image/x-icon" rel="shortcut icon">
    <link rel="stylesheet" type="text/css" href="/thinkox4/Public/Admin/css/base.css" media="all">
    <link rel="stylesheet" type="text/css" href="/thinkox4/Public/Admin/css/common.css" media="all">
    <link rel="stylesheet" type="text/css" href="/thinkox4/Public/Admin/css/module.css">
    <link rel="stylesheet" type="text/css" href="/thinkox4/Public/Admin/css/style.css" media="all">
    <link rel="stylesheet" type="text/css" href="/thinkox4/Public/Admin/css/<?php echo (C("COLOR_STYLE")); ?>.css" media="all">
    <!--[if lt IE 9]>
    <script type="text/javascript" src="/thinkox4/Public/static/jquery-1.10.2.min.js"></script>
    <![endif]--><!--[if gte IE 9]><!-->
    <script type="text/javascript" src="/thinkox4/Public/static/jquery-2.0.3.min.js"></script>
    <script type="text/javascript" src="/thinkox4/Public/Admin/js/jquery.mousewheel.js"></script>
    <!--<![endif]-->
...
<div id="main-content">
    ...
    <script type="text/javascript" src="/thinkox4/Public/static/uploadify/jquery.uploadify.min.js"></script>
                    ...
                    <?php case "image": ?><div class="controls">
                        ...
                        <script type="text/javascript">
                            ...
                            $("#upload_picture_<?php echo ($field["name"]); ?>").uploadify({
                                "height"          : 30,
                                "swf"             : "/thinkox4/Public/static/uploadify/uploadify.swf",
                            ...
                            function uploadPicture<?php echo ($field["name"]); ?>(file, data){
                                ...
                                if(data.status){
                                    ...
                                    src = data.url || '/thinkox4' + data.path
...
<script type="text/javascript">
    (function () {
        var ThinkPHP = window.Think = {
            "ROOT": "/thinkox4", //当前网站地址
            "APP": "/thinkox4/index.php?s=", //当前项目地址
            "PUBLIC": "/thinkox4/Public", //项目公共目录地址
...
<script type="text/javascript" src="/thinkox4/Public/static/think.js"></script>
<script type="text/javascript" src="/thinkox4/Public/Admin/js/common.js"></script>
<script type="text/javascript">
    +function () {
    ...
    <?php if($importDatetimePicker): ?><link href="/thinkox4/Public/static/datetimepicker/css/datetimepicker.css" rel="stylesheet" type="text/css">
        <?php if(C('COLOR_STYLE')=='blue_color') echo '<link href="/thinkox4/Public/static/datetimepicker/css/datetimepicker_blue.css" rel="stylesheet" type="text/css">'; ?>
        <link href="/thinkox4/Public/static/datetimepicker/css/dropdown.css" rel="stylesheet" type="text/css">
        <script type="text/javascript" src="/thinkox4/Public/static/datetimepicker/js/bootstrap-datetimepicker.min.js"></script>
        <script type="text/javascript" src="/thinkox4/Public/static/datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js" charset="UTF-8"></script>
