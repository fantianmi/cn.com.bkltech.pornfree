...
<div id="main-content">
    ...
    <div class="cf">
        ...
        <button url="<?php echo U('Zhengzhuang/clear');?>" class="btn ajax-post" target-form="ids">清 空</button>
        <button url="<?php echo U('Zhengzhuang/huanyuan');?>" class="btn ajax-post" target-form="ids">还 原</button>
    </div>
    ...
    <div class="data-table table-striped">
        <table class="">
            ...
            <?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td>
                            <a href="<?php echo U('Zhengzhuang/huanyuan?method=deleteUser&id='.$vo['id']);?>"
